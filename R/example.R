...
#   ),
#   initial     = Dirichlet(alpha = c(0.1, 0.5, 1)),
#   transition  = Dirichlet(alpha = c(0.1, 0.5, 1)) + Dirichlet(alpha = c(7.1, 6.5, 5)) + Dirichlet(alpha = c(1.1, 2.5, 3)),
#   name = "My simple model."
# )
...
#   K = 3, R = 3,
#   Gaussian(
#     mu    = Gaussian(0, 10, k = "", r = "", param = "mu"),
#     sigma = Gaussian(0, 10, k = "", r = "", param = "sigma")
#   )
# )
#
# obs1 <- parse_observation(
...
#     ),
#   initial     = Dirichlet(alpha = c(0.1, 0.5, 1)),
#   transition  = Dirichlet(alpha = c(0.1, 0.5, 1)), ## make it compile, remove the extra parameters that should be computed automatically
#   name = "My simple model."
# )
#
