...
#'   Q     = 3
#' )
InitialSoftmax <- function(vBeta = NULL, Q = NULL, ordered = NULL, equal = NULL, bounds = list(NULL, NULL),
                    trunc = list(NULL, NULL), k = NULL, r = NULL, param = NULL) {
  LinkDensity("InitialSoftmax", ordered, equal, bounds, trunc, k, r, param, vBeta = vBeta, Q = Q)
}
