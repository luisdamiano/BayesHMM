...
#'
#' @param fit An object returned by \code{\link{fit}}, \code{\link{drawSamples}}, or \code{\link{optimizing}}.
...
#'
#' @param fit An object returned by either \code{\link{drawSamples}} or \code{\link{optimizing}}.
#' @return For objects fit via \code{\link{drawSamples}}, a named numeric matrix with two columns (warm-up and sample time) and one row per chain. For objects fit via \code{\link{optimizing}}, the system time elapsed.
