...
setGeneric(
  "extract_diagnostics",
  function(stanfit, pars = select_obs_parameters(stanfit), trueParameters = NULL) {
    standardGeneric("extract_diagnostics")
  }
)

#' @rdname extract_diagnostics
#' @aliases extract_diagnostics,stanfit-method
setMethod("extract_diagnostics", "stanfit", function(stanfit, pars = select_obs_parameters(stanfit), trueParameters = NULL) {
