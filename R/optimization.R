...
#' @keywords internal
#' @describeIn extract_grid For \code{\link{Optimization}} objects, which are returned by \code{\link{optimizing}} with \emph{keep} set to \emph{best}.
