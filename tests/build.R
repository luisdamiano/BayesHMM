...
build_objects <- function(pathOut) {
  ...
  # #   myFitSpec, N = 1, T = tLength, seed = seed, nCores = 12, iter = 500
  # # )
  # # saveRDS(mySims, file.path(pathOut, "sim.RDS"))
  #
  # # 3. compile
  ...
  # myFit  <- sampling(myFitSpec, myComp, y = ySim, chains = 2, iter = 500)
  # saveRDS(myFit, file.path(sampling, "compile.RDS"))
  #
  # # 5. optimizating
  # myOpt  <- optimizing(myFitSpec, myComp, y = ySim, nRuns = 10, nCores = 10)
  # saveRDS(myOpt, file.path(optimizing, "compile.RDS"))
}
